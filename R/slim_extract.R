...
#'       slimr_output(p1$size(), "MS", do_every = 10)
#'     })
#'   ) %>%
...
#'     slim_block_add_subpops(1, 100),
#'     slim_block(1, 20, late(), {
#'       slimr_output(p1.genomes.output(), "out", do_every = 10)
#'     })
#'   ) %>%
#'     slim_run()
...
#'
#' @param x \code{slimr_results} object containing data generated by \code{slimr_output}
