...
#'
#' @examples
slim_run_script <- function(slim_script = NULL, script_file = NULL, slim_path = NULL, output = NULL, output_every = 1, output_sample = NULL, output_format = c("genlight", "slim_tibble", "vcf_tibble"), .progress = TRUE, write_data_live = FALSE, log_output_to = NULL, subpops = "all", remove_console_output = TRUE, allow_output_files = TRUE, slim_wd = NULL) {
