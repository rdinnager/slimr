...
If you want to add this path permanently to your RStudio installation (so no need to run `Sys.setenv()` every time) you can use the command ``` usethis::edit_r_environ()``` and add a line like ```SLIMR_PATH='C:/Program Files/R/R-4.3.1/library/slimr'``` to this file.
