...
str(sr)
#> List of 6
#>  $ output     : chr [1:42] "// Initial random seed:" "3406448750" "" "// RunInitializeCallbacks():" ...
#>  $ exit_status: int 0
...
#>   ..$ data      : chr [1:10] "#OUT: 10 GS 66\nMutations:\n31 0 m1 48491 0 0.5 p1 1 7\n137 5 m1 46245 0 0.5 p1 1 4\n140 6 m1 58832 0 0.5 p1 1 "| __truncated__ "#OUT: 20 GS 66\nMutations:\n41 0 m1 48491 0 0.5 p1 1 12\n274 5 m1 46245 0 0.5 p1 1 5\n279 6 m1 58832 0 0.5 p1 1"| __truncated__ "#OUT: 30 GS 66\nMutations:\n46 0 m1 48491 0 0.5 p1 1 12\n355 5 m1 46245 0 0.5 p1 1 1\n362 6 m1 58832 0 0.5 p1 1"| __truncated__ "#OUT: 40 GS 66\nMutations:\n59 0 m1 48491 0 0.5 p1 1 24\n355 5 m1 46245 0 0.5 p1 1 1\n363 6 m1 58832 0 0.5 p1 1"| __truncated__ ...
#>   ..- attr(*, "spec")=
#>   .. .. cols(
...
#>  
#>  $ error      : chr(0) 
#>  $ output_file: chr "C:\\Users\\s425824\\AppData\\Local\\Temp\\RtmpCIkMEk\\file6930c8b5aa3.txt"
...
#>  /// GENLIGHT OBJECT /////////
#> 
#>  // 33 genotypes,  269 binary SNPs, size: 73.5 Kb
#>  0 (0 %) missing data
#> 
#>  // Basic content
...
And finally we can use a simply `lapply` to find the number of loci for
