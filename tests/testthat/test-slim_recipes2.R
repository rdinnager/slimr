test_that("All slim recipes work", {
  ...
  ## 159: The SLiM Manual says this recipe takes 'several hours' to run, so let's not test it
  ## 163: Requires a pregenerated tree sequence file (generated in Python)
