---
title: "Advanced Example: Multispecies Spatial Model with SLiMGUI Integration Demonstration"
---
...
slim_script(
    ...
    slim_block(all = 2, !!n_gen, first(),  {
        ...
        dead.tag = 1
        r_output(hosts.size(), "host_pop_size")
        r_output(parasitoids.size(), "parasitoid_pop_size")
    }),
