...
Monitoring progress in real-time is great but it doesn't work too well in a static document like this, so we will just collect information about how the run is going into an object which we can plot later.
